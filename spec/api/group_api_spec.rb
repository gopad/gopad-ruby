...
describe 'GroupApi' do
  ...
  describe 'test an instance of GroupApi' do
    it 'should create an instance of GroupApi' do
      expect(@api_instance).to be_instance_of(Gopad::GroupApi)
    end
  end
  ...
  # @param permit_group_user_request The group user data to permit
  ...
  # @param group_id A group identifier or slug
  # @param delete_group_from_user_request The group user data to unlink
  # @param [Hash] opts the optional parameters
  # @return [Notification]
