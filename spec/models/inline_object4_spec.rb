...
# Unit tests for Gopad::InlineObject4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Gopad::InlineObject4 do
  let(:instance) { Gopad::InlineObject4.new }

  describe 'test an instance of InlineObject4' do
    it 'should create an instance of InlineObject4' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Gopad::InlineObject4)
    end
  end
