...
# Unit tests for Gopad::ListUsers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Gopad::ListUsers200Response do
  let(:instance) { Gopad::ListUsers200Response.new }

  describe 'test an instance of ListUsers200Response' do
    it 'should create an instance of ListUsers200Response' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Gopad::ListUsers200Response)
    end
  end
