...
# Unit tests for Gopad::CreateUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Gopad::CreateUserRequest do
  let(:instance) { Gopad::CreateUserRequest.new }

  describe 'test an instance of CreateUserRequest' do
    it 'should create an instance of CreateUserRequest' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Gopad::CreateUserRequest)
    end
  end
