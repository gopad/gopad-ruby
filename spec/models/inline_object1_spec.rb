...
# Unit tests for Gopad::InlineObject1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Gopad::InlineObject1 do
  let(:instance) { Gopad::InlineObject1.new }

  describe 'test an instance of InlineObject1' do
    it 'should create an instance of InlineObject1' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Gopad::InlineObject1)
    end
  end
