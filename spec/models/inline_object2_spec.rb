...
# Unit tests for Gopad::InlineObject2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Gopad::InlineObject2 do
  let(:instance) { Gopad::InlineObject2.new }

  describe 'test an instance of InlineObject2' do
    it 'should create an instance of InlineObject2' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Gopad::InlineObject2)
    end
  end
